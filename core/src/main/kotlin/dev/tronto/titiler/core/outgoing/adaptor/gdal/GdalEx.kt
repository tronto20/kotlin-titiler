...
operator fun DataType.Companion.get(gdalConst: Int): DataType {
    return when (gdalConst) {
...
operator fun ColorInterpretation.Companion.get(gdalConst: Int): ColorInterpretation {
    return when (gdalConst) {
